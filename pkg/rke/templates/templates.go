...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Aci: {
			...
			">=1.25.13-rancher1-1 <1.25.15-rancher1-1": aciv6031,
			">=1.25.15-rancher1-1 <1.26.0-rancher0":    aciv6032,
			">=1.26.0-rancher0 <1.26.8-rancher1-1":     aciv5271,
			">=1.26.8-rancher1-1 <1.26.10-rancher1-1":  aciv6031,
			">=1.26.10-rancher1-1 <1.27.0-rancher0":    aciv6032,
			">=1.27.7-rancher1-1":                      aciv6032,
		},
		kdm.NginxIngress: {
