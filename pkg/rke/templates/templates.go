...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Aci: {
			...
			">=1.24.13-rancher2-2 <1.24.16-rancher1-2": aciv5271,
			">=1.24.16-rancher1-2 <1.25.0-rancher0":    aciv6031,
			">=1.25.0-rancher0 <1.25.9-rancher2-1":     aciv5235,
			">=1.25.9-rancher2-1 <1.25.9-rancher2-2":   aciv5236,
			">=1.25.9-rancher2-2 <1.25.12-rancher1-2":  aciv5271,
			">=1.25.12-rancher1-2 <1.26.0-rancher0":    aciv6031,
			">=1.26.0-rancher0 <1.26.7-rancher1-2":     aciv5271,
			">=1.26.7-rancher1-2":                      aciv6031,
		},
		kdm.NginxIngress: {
