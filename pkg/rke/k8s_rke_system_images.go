...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.24.16-rancher1-2": {
			...
			WeaveNode:                   "weaveworks/weave-kube:2.8.1",
			WeaveCNI:                    "weaveworks/weave-npc:2.8.1",
			AciCniDeployContainer:       "noiro/cnideploy:6.0.3.1.81c2369.z",
			AciHostContainer:            "noiro/aci-containers-host:6.0.3.1.81c2369.z",
			AciOpflexContainer:          "noiro/opflex:6.0.3.1.81c2369.z",
			AciMcastContainer:           "noiro/opflex:6.0.3.1.81c2369.z",
			AciOpenvSwitchContainer:     "noiro/openvswitch:6.0.3.1.81c2369.z",
			AciControllerContainer:      "noiro/aci-containers-controller:6.0.3.1.81c2369.z",
			AciGbpServerContainer:       "noiro/gbp-server:6.0.3.1.81c2369.z",
			AciOpflexServerContainer:    "noiro/opflex-server:6.0.3.1.81c2369.z",
			AciCniDeployContainerSha:    "noiro/cnideploy",
			AciHostContainerSha:         "noiro/aci-containers-host",
			AciOpflexContainerSha:       "noiro/opflex",
			AciMcastContainerSha:        "noiro/opflex",
			AciOpenvSwitchContainerSha:  "noiro/openvswitch",
			AciControllerContainerSha:   "noiro/aci-containers-controller",
			AciOpflexServerContainerSha: "noiro/opflex-server",
			PodInfraContainer:           "rancher/mirrored-pause:3.7",
			Ingress:                     "rancher/nginx-ingress-controller:nginx-1.5.1-rancher2",
			IngressBackend:              "rancher/mirrored-nginx-ingress-controller-defaultbackend:1.5-rancher1",
			IngressWebhook:              "rancher/mirrored-ingress-nginx-kube-webhook-certgen:v1.1.1",
