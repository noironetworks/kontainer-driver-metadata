...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.28.12-rancher1-1": {
			...
			WeaveNode:                 "weaveworks/weave-kube:2.8.1",
			WeaveCNI:                  "weaveworks/weave-npc:2.8.1",
			AciCniDeployContainer:     "noiro/cnideploy:6.0.4.3.81c2369.z",
			AciHostContainer:          "noiro/aci-containers-host:6.0.4.3.81c2369.z",
			AciOpflexContainer:        "noiro/opflex:6.0.4.3.81c2369.z",
			AciMcastContainer:         "noiro/opflex:6.0.4.3.81c2369.z",
			AciOpenvSwitchContainer:   "noiro/openvswitch:6.0.4.3.81c2369.z",
			AciControllerContainer:    "noiro/aci-containers-controller:6.0.4.3.81c2369.z",
			PodInfraContainer:         "rancher/mirrored-pause:3.7",
			Ingress:                   "rancher/nginx-ingress-controller:nginx-1.9.6-rancher1",
			IngressBackend:            "rancher/mirrored-nginx-ingress-controller-defaultbackend:1.5-rancher1",
			IngressWebhook:            "rancher/mirrored-ingress-nginx-kube-webhook-certgen:v20231226-1a7112e06",
