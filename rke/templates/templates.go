...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Aci: {
			...
			">=1.24.8-rancher1-1 <1.24.8-rancher1-2":  aciv5234,
			">=1.24.8-rancher1-2 <1.25.0-rancher0":   aciv5235,
			">=1.25.0-rancher0 <1.25.2-rancher1-2":   aciv523,
			">=1.25.2-rancher1-2":                    aciv5235,
		},
		kdm.NginxIngress: {
