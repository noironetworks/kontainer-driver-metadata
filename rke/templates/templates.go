...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Aci: {
			...
			">=1.22.16-rancher1-1 <1.22.17-rancher1-2": aciv5234,
			">=1.22.17-rancher1-2 <1.23.0-rancher0":    aciv5235,
			">=1.23.0-rancher0 <1.23.8-rancher1-1":     aciv500,
			">=1.23.8-rancher1-1 <1.23.14-rancher1-1":  aciv523,
			">=1.23.14-rancher1-1 <1.23.15-rancher1-2": aciv5234,
			">=1.23.15-rancher1-2 <1.24.0-rancher0":    aciv5235,
			">=1.24.0-rancher0 <1.24.8-rancher1-1":     aciv523,
			">=1.24.8-rancher1-1<1.24.9-rancher1-2":    aciv5234,
			">=1.24.9-rancher1-2":                      aciv5235,
		},
		kdm.NginxIngress: {
