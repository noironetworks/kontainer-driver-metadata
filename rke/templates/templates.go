...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Aci: {
			">=1.17.0-alpha <=1.18.16-rancher1-1":   aciv500,
			">=1.19.0-rancher0 <=1.19.8-rancher1-1": aciv500,
			">=1.20.0-rancher0 <=1.20.4-rancher1-1": aciv500,
			">=1.18.16-rancher1-2 <1.19.0-rancher0": aciv513,
			">=1.19.8-rancher1-2 <1.20.0-rancher0":  aciv513,
			">=1.20.4-rancher1-2":                   aciv513,
		},
		kdm.NginxIngress: {
