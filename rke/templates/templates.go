...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Aci: {
			...
			">=1.24.9-rancher1-1 <1.24.10-rancher4-2":  aciv5235,
			">=1.24.10-rancher4-2 <1.25.0-rancher0":    aciv5236,
			">=1.25.0-rancher0 <1.25.6-rancher4-2":     aciv5235,
			">=1.25.6-rancher4-2":                      aciv5236,
		},
		kdm.NginxIngress: {
