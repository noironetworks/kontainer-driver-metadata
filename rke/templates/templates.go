...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.Aci: {
			...
			">=1.23.14-rancher1-1 <1.23.14-rancher1-2": aciv5234,
			">=1.23.14-rancher1-2 <1.24.0-rancher0":    aciv5235,
			">=1.24.0-rancher0 <1.24.8-rancher1-1":     aciv523,
			">=1.24.8-rancher1-1 <v1.24.8-rancher1-2":  aciv5234,
			">=v1.24.8-rancher1-2 <v1.25.0-rancher0":   aciv5235,
			">=v1.25.0-rancher0 <v1.25.2-rancher1-2":   aciv523,
			">=<v1.25.2-rancher1-2":                    aciv5235,
		},
		kdm.NginxIngress: {
