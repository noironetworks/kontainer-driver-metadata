...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.18.16-rancher1-2": {
			...
			WeaveNode:                 m("weaveworks/weave-kube:2.6.4"),
			WeaveCNI:                  m("weaveworks/weave-npc:2.6.4"),
			AciCniDeployContainer:     m("noiro/cnideploy:5.1.3.1.6f00d68"),
			AciHostContainer:          m("noiro/aci-containers-host:5.1.3.1.6f00d68"),
			AciOpflexContainer:        m("noiro/opflex:5.1.3.1.6f00d68"),
			AciMcastContainer:         m("noiro/opflex:5.1.3.1.6f00d68"),
			AciOpenvSwitchContainer:   m("noiro/openvswitch:5.1.3.1.6f00d68"),
			AciControllerContainer:    m("noiro/aci-containers-controller:5.1.3.1.6f00d68"),
			AciGbpServerContainer:     m("noiro/gbp-server:5.1.3.1.6f00d68"),
			AciOpflexServerContainer:  m("noiro/opflex-server:5.1.3.1.6f00d68"),
			AciGbpServerInitContainer: m("noiro/gbp-server-batch:5.1.3.1.6f00d68"),
			PodInfraContainer:         m("gcr.io/google_containers/pause:3.1"),
			Ingress:                   m("rancher/nginx-ingress-controller:nginx-0.35.0-rancher2"),
			IngressBackend:            m("rancher/nginx-ingress-controller-defaultbackend:1.5-rancher1"),
			MetricsServer:             m("gcr.io/google_containers/metrics-server:v0.3.6"),
