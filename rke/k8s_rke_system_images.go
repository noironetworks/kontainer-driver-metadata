...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.24.13-rancher2-2": {
			...
			WeaveNode:                 "weaveworks/weave-kube:2.8.1",
			WeaveCNI:                  "weaveworks/weave-npc:2.8.1",
			AciCniDeployContainer:     "noiro/cnideploy:5.2.3.7.1d150da",
			AciHostContainer:          "noiro/aci-containers-host:5.2.3.7.1d150da",
			AciOpflexContainer:        "noiro/opflex:5.2.3.7.1d150da",
			AciMcastContainer:         "noiro/opflex:5.2.3.7.1d150da",
			AciOpenvSwitchContainer:   "noiro/openvswitch:5.2.3.7.1d150da",
			AciControllerContainer:    "noiro/aci-containers-controller:5.2.3.7.1d150da",
			AciGbpServerContainer:     "noiro/gbp-server:5.2.3.7.1d150da",
			AciOpflexServerContainer:  "noiro/opflex-server:5.2.3.7.1d150da",
			PodInfraContainer:         "rancher/mirrored-pause:3.7",
			Ingress:                   "rancher/nginx-ingress-controller:nginx-1.5.1-rancher2",
			IngressBackend:            "rancher/mirrored-nginx-ingress-controller-defaultbackend:1.5-rancher1",
			IngressWebhook:            "rancher/mirrored-ingress-nginx-kube-webhook-certgen:v1.1.1",
