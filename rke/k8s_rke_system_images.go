...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.16.13-rancher1-3": {
			...
			WeaveCNI:                  m("weaveworks/weave-npc:2.6.4"),
			PodInfraContainer:         m("gcr.io/google_containers/pause:3.1"),
			AciCniDeployContainer:     m("noiro/cnideploy:5.0.2.1.05bf1b8"),
			AciHostContainer:          m("noiro/aci-containers-host:5.0.2.1.05bf1b8"),
			AciOpflexContainer:        m("noiro/opflex:5.0.2.1.05bf1b8"),
			AciMcastContainer:         m("noiro/opflex:5.0.2.1.05bf1b8"),
			AciOpenvSwitchContainer:   m("noiro/openvswitch:5.0.2.1.05bf1b8"),
			AciControllerContainer:    m("noiro/aci-containers-controller:5.0.2.1.05bf1b8"),
			AciGbpServerContainer:     m("noiro/gbp-server:5.0.2.1.05bf1b8"),
			AciOpflexServerContainer:  m("noiro/opflex-server:5.0.2.1.05bf1b8"),
			Ingress:                   m("rancher/nginx-ingress-controller:nginx-0.32.0-rancher1"),
			IngressBackend:            m("k8s.gcr.io/defaultbackend:1.5-rancher1"),
			MetricsServer:             m("gcr.io/google_containers/metrics-server:v0.3.4"),
			CoreDNS:                   m("coredns/coredns:1.6.2"),
